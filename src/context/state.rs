...
impl AppState {
    ...
    pub(crate) async fn from_env() -> Result<AppState, AppStateError> {
        ...
        let ch_client = clickhouse::Client::default()
            ...
            .with_option("query_cache_nondeterministic_function_handling", "save")
            .with_option("query_cache_share_between_users", "1")
            .with_option("query_cache_system_table_handling", "ignore")
            .with_option("optimize_if_transform_strings_to_enum", "1")
            .with_option("optimize_syntax_fuse_functions", "1")
            .with_option("allow_aggregate_partitions_independently", "1")
            .with_option("max_threads", "12")
