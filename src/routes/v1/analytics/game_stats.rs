...
fn build_query(query: &GameStatsQuery) -> String {
    ...
    SELECT
        ...
        avg(max_gold_player) AS avg_gold_player,
        avg(max_gold_lane_creep) AS avg_gold_lane_creep,
        avg(max_gold_neutral_creep) AS avg_gold_neutral_creep,
        avg(max_gold_boss) AS avg_gold_boss,
        avg(max_gold_treasure) AS avg_gold_treasure,
        avg(max_gold_denied) AS avg_gold_denied,
        avg(max_gold_death_loss) AS avg_gold_death_loss,
        avgIf(tm.first_mid_boss_time_s, tm.has_mid_boss) AS avg_first_mid_boss_time_s,
