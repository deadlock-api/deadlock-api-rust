...
impl Metric {
    pub(super) fn get_select_clause(self) -> &'static str {
        match self {
            ...
            Self::DamagePerHealth => "max_player_damage / greatest(1, max_max_health)",
            Self::DamagePerMin => "max_player_damage / greatest(1, duration_s) * 60",
            Self::DamageTakenPerMin => "max_player_damage_taken / greatest(1, duration_s) * 60",
        }
    }
    ...
    pub(super) fn extract_values(self, row: &AnalyticsPlayerStatsMetricsRow) -> MetricValues {
        match self {
            ...
            Self::DamagePerHealth => MetricValues {
                avg: row.avg_damage_per_health,
                std: row.std_damage_per_health,
                percentile1: row.quantiles_damage_per_health[0],
                percentile5: row.quantiles_damage_per_health[1],
                percentile10: row.quantiles_damage_per_health[2],
                percentile25: row.quantiles_damage_per_health[3],
                percentile50: row.quantiles_damage_per_health[4],
                percentile75: row.quantiles_damage_per_health[5],
                percentile90: row.quantiles_damage_per_health[6],
                percentile95: row.quantiles_damage_per_health[7],
                percentile99: row.quantiles_damage_per_health[8],
            },
            Self::DamagePerMin => MetricValues {
                avg: row.avg_damage_per_min,
                std: row.std_damage_per_min,
                percentile1: row.quantiles_damage_per_min[0],
                percentile5: row.quantiles_damage_per_min[1],
                percentile10: row.quantiles_damage_per_min[2],
                percentile25: row.quantiles_damage_per_min[3],
                percentile50: row.quantiles_damage_per_min[4],
                percentile75: row.quantiles_damage_per_min[5],
                percentile90: row.quantiles_damage_per_min[6],
                percentile95: row.quantiles_damage_per_min[7],
                percentile99: row.quantiles_damage_per_min[8],
            },
            Self::DamageTakenPerMin => MetricValues {
                avg: row.avg_damage_taken_per_min,
                std: row.std_damage_taken_per_min,
                percentile1: row.quantiles_damage_taken_per_min[0],
                percentile5: row.quantiles_damage_taken_per_min[1],
                percentile10: row.quantiles_damage_taken_per_min[2],
                percentile25: row.quantiles_damage_taken_per_min[3],
                percentile50: row.quantiles_damage_taken_per_min[4],
                percentile75: row.quantiles_damage_taken_per_min[5],
                percentile90: row.quantiles_damage_taken_per_min[6],
                percentile95: row.quantiles_damage_taken_per_min[7],
                percentile99: row.quantiles_damage_taken_per_min[8],
            },
        }
    }
}
...
pub(super) struct AnalyticsPlayerStatsMetricsRow {
    ...
    avg_damage_per_health: f64,
    std_damage_per_health: f64,
    quantiles_damage_per_health: Vec<f64>,
    avg_damage_per_min: f64,
    std_damage_per_min: f64,
    quantiles_damage_per_min: Vec<f64>,
    avg_damage_taken_per_min: f64,
    std_damage_taken_per_min: f64,
    quantiles_damage_taken_per_min: Vec<f64>,
}
...
async fn get_player_stats_metrics(
    ...
    debug!(?query_str);
    Ok(ch_client.query(&query_str).fetch_one().await?)
}
